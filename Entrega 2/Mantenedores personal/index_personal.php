                    ...
                    <table class="table table-bordered border-primary texto_listado">
                        ...
                        <tbody>
                            ...
                            while ($row=mysqli_fetch_assoc($resultado)) {
                                ...
                                echo "<td><a class='boton' href='funcion_eliminar_personal.php?seleccionado=".$run_personal_recibido."'><button value='eliminar' class='btn btn-primary' type='button'>Eliminar</button></a>  <a class='boton' href='editar_personal.php?seleccionado=".$run_personal_recibido."'><button value='Editar' class='btn btn-primary' type='button'>Editar</button></a></td>";
                                echo "</tr>";
                            }
                            ?>
                        </tbody>
