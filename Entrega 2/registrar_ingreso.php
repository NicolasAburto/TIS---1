                    ...
                    <div class="col">
                        <?php
                            ...
                            echo "<table border=1>";
                                ...
                                echo "</tr>";
                                $fecha = date('Y-m-d');
                                $query = "SELECT personal.nombre, puede.hora_ingreso, puede.hora_salida FROM personal, puede WHERE fecha_ingreso='$fecha' AND personal.run = puede.run_personal ORDER BY hora_ingreso DESC";
