            ...
            <div class="col-lg-6 col-md-12 col-sm-12">
                <form action="funcion_guardar_personal.php" method="POST" class="formulario_personal">
                    ...
                    <div class="d-grid gap-2 pt-5 boton">
                        ...
                        <strong>Bien!</strong> El usuario ha sido ingresado con éxito.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <?php
                            }
                        ...
                        ?>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <strong>Bien!</strong> El usuario ha sido actualizado con éxito.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <?php
                            }
                        ...
                        ?>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <strong>Bien!</strong> El usuario ha sido eliminado con éxito.
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                        </div>
                        <?php
                            }
