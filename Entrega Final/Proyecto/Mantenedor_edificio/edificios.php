    ...
    <div class="row">
      ...
      <div class="col-lg-6 col-md-12 col-sm-12">
        <form action="insertar-edificio.php" method="POST" class="formulario_edificio">
          ...
          <div class="mb-3">
            <label class="form-label texto_registro">Capacidad máxima</label>
          ...
          <div class="d-grid gap-2 pt-4 boton">
            ...
            <strong>Error!</strong> Este run ya existe.
            ...
            <strong>Bien!</strong> El edificio ha sido ingresado con éxito.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
            <?php
                }
            ...
            <!-- Success -->
            <?php
                if(isset($_GET['successupdate']) and $_GET['successupdate'] == 1){
            ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Bien!</strong> El edificio ha sido actualizado con éxito.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
            <?php
                }
            ...
            <!-- Success -->
            <?php
                if(isset($_GET['successeliminar']) and $_GET['successeliminar'] == 1){
            ?>
            <div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Bien!</strong> El edificio ha sido eliminado con éxito.
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
            <?php
                }
