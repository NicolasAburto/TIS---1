  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="row capacontainer">
            <div class="col-lg-6">
                ...
                <?php
                    ...
                    <strong>Error!</strong> El usuario ingresado no está al interior de un edificio.
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    <?php
                    }
                ...
                <?php
                    ...
                    ?>
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                    <strong>Error!</strong> El usuario ingresado no está al interior del edificio seleccionado.
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    <?php
                    }
                ...
                <?php
                    ...
                    <strong>Bien!</strong> Salida Exitosa.
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                    <?php
                    }
    ...
    <script>
        var timer = setTimeout(function() {
            window.location='totem_salida.php'
        }, 900000);
    </script>
