    ...
    <div class="container-fluid fondoportal">
        ...
        <div class="datosanteriores_capacontainer">        
            <div class="row contenedor_datosanteriores">  
                ...
                <form action="dompdf/generar_reporte_anterior.php" method="GET" align="center" class="mt-5 boton ">
                    <select name="input_nombre_edificio" class="edificios_datosant mb-2 mt-4" hidden>
                        <option><?php echo "$input_nombre_edificio"?></option>
                    </select>
                    <input type="date" name="dia_elegido" value="<?php echo "$dia"?>" hidden>
                    <input type="WEEK" name="semana_elegido" value="<?php echo "$semana"?>" hidden>
                    <input type="MONTH" name="mes_elegido" value="<?php echo "$mes"?>" hidden>

                        <button type="submit" value="imprimir"class="btn btn-primary" type="button">Imprimir</button>
                </form>
            </div>
