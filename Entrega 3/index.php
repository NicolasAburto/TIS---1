            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="container contenedor">
                    ...
                    <div class="col">
                        ...
                        <h5 align="center" class="subtitulo">Medidas de prevención COVID-19 de la UCSC</h5>
                    </div>
                    <div class="row" align="center">
                        ...
                        <div class="col">
                            <a class="btn btn-outline-secondary _a" href="faq.php" role="button">¿Necesitas ayuda?</a>
                        </div>
                    </div>
                    <div class="row" align="center">
                        <div class="col">
                            <a class="btn btn-outline-secondary _a" href="datosanteriores.php" role="button">Ver datos pasados</a>
                        </div>
                        <div class="col">
